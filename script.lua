...
-- FAST AUTO LEFT / RIGHT (NO DELAY)

local left1 = Vector3.new(-473.90,-7.00,27.34)
local left2 = Vector3.new(-486.40,-4.79,-22.61)

local right1 = Vector3.new(-473.00,-7.00,92.62)
local right2 = Vector3.new(-489.31,-5.04,98.51)
...
if not autoLeft then return end
...
if not autoRight then return end
